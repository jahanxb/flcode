    ...
    try:
            ...
            for t in range(args.round):
                ...
                while True:
                    ...
                    try:
                        time.sleep(5)
                        status = mdb.master_global_for_node1.find_one({'task_id':new_global_model_queue_id})
                ...
                if t==0:
                    ...
                    parameters = pika.ConnectionParameters(host='130.127.134.6', port=5672, credentials=credentials, heartbeat=36000)
