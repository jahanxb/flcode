...
if __name__ == '__main__':
    ...
    for t in range(args.round):
        ...
        #val_loss, val_accuracy, val_labels, val_preds = validate_model(net_glob, ldr_train_public, criterion, args.device)
        #print(f"Round {t}: Validation Loss: {val_loss}, Validation Accuracy: {val_accuracy}%")
    
        #if t % 5 == 0:  # Plot confusion matrix every 5 rounds
        #    plot_confusion_matrix(val_labels, val_preds, classes=[str(i) for i in range(10)])
