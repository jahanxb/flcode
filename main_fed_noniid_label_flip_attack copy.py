...
def fmnist_noniid_old_function(dataset, num_users, flip_mapping, flip_fraction):
    """
    Sample non-I.I.D client data from FashionMNIST dataset with optional label flipping attack
    :param dataset: Dataset object containing the data
    :param num_users: Number of users (clients)
...
Flipping labels for users: [4]
Before flipping: User 4, Labels: (array([1, 2, 5, 6]), array([100, 100, 100, 100]))
After flipping: User 4, Labels: (array([2, 5, 6, 9]), array([100, 100, 100, 100]))
Label 1 flipped to 9: 100 -> 100
Label 1 was flipped correctly to 9
Label 3 flipped to 7: 0 -> 0
Label 3 flipping to 7 failed
Label 5 flipped to 5: 100 -> 100
Label 5 was flipped correctly to 5
...
./log/fmnist/fedavg/cnn/round_10_tau_10_frac_1.0
=============== model setup ================================
User 0: Label distribution {1: 100, 6: 100, 7: 100, 8: 100}
User 1: Label distribution {4: 200, 7: 100, 8: 100}
User 2: Label distribution {2: 200, 6: 100}
User 3: Label distribution {8: 100, 9: 100}
User 4: Label distribution {2: 100, 5: 100, 6: 100, 9: 100}
User 5: Label distribution {2: 100, 6: 100}
User 6: Label distribution {2: 100, 5: 100, 6: 100}
User 7: Label distribution {3: 100}
User 8: Label distribution {0: 100, 5: 200, 6: 100}
User 9: Label distribution {8: 100, 9: 100}
=============== verifying non-IID distribution =============
User 0: Label distribution {1: 100, 6: 100, 7: 100, 8: 100}
User 1: Label distribution {4: 200, 7: 100, 8: 100}
User 2: Label distribution {2: 200, 6: 100}
...
User 9: Label distribution {8: 100, 9: 100}
=============== training... ================================
t   0: train_loss = 0.905, norm = 1.998, test_acc = 17.144
t   1: train_loss = 0.482, norm = 1.408, test_acc = 33.989
t   2: train_loss = 0.334, norm = 1.024, test_acc = 45.778
t   3: train_loss = 0.291, norm = 0.976, test_acc = 43.022
t   4: train_loss = 0.267, norm = 0.824, test_acc = 52.633
t   5: train_loss = 0.235, norm = 1.016, test_acc = 46.533
t   6: train_loss = 0.223, norm = 0.986, test_acc = 52.067
t   7: train_loss = 0.217, norm = 1.101, test_acc = 28.867
t   8: train_loss = 0.246, norm = 0.951, test_acc = 52.856
t   9: train_loss = 0.209, norm = 1.004, test_acc = 48.656
training time: 00:00:40.58
