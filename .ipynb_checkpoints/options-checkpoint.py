...
def args_parser():
    ...
    parser.add_argument('--num_data',  # This is not used if data is split IID.
                        type=int,
                        default=500,
    ...
    parser.add_argument('--db', type=str, default='mongodb',help='Select Database System [mongodb | cassandra | scp | rabbitmq | postgres | neo4j ]')
