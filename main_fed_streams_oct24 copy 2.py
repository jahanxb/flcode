        ...
        if t==0:
            ...
            try:
                ...
                connection.close()
                        ...
                        ###########trying to add old ones ############
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{0}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{0}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            ############ adding old values #####################
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{0}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{0}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k]) / num_selected_users
                for k in global_model.keys()
            }
            ...
            local_updates.append(lp0)
            local_updates.append(lp1)
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{1}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{1}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{1}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{1}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k]) / num_selected_users
                for k in global_model.keys()
            }
            ...
            local_updates.append(lp0)
            local_updates.append(lp1)
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{2}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{2}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{2}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{2}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k]) / num_selected_users
                for k in global_model.keys()
            }
            ...
            local_updates.append(lp0)
            local_updates.append(lp1)
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{3}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{3}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{3}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{3}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k] + local_updates[8][0][k] + local_updates[9][0][k] ) / num_selected_users
                for k in global_model.keys()
            }
            ...
            local_updates.append(lp0)
            local_updates.append(lp1)
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{4}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{4}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{4}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{4}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k] + local_updates[8][0][k] + local_updates[9][0][k] + local_updates[10][0][k] + local_updates[11][0][k] ) / num_selected_users
                for k in global_model.keys()
            }
            ...
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{5}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{5}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{5}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{5}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k] + local_updates[8][0][k] + local_updates[9][0][k] + local_updates[10][0][k] + local_updates[11][0][k] + local_updates[12][0][k] + local_updates[13][0][k] ) / num_selected_users
                for k in global_model.keys()
            }
            ...
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{6}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{6}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{6}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{6}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k] + local_updates[8][0][k] + local_updates[9][0][k] + local_updates[10][0][k] + local_updates[11][0][k] + local_updates[12][0][k] + local_updates[13][0][k] + local_updates[14][0][k] + local_updates[15][0][k] ) / num_selected_users
                for k in global_model.keys()
            }
            ...
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{7}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{7}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{7}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{7}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k] + local_updates[8][0][k] + local_updates[9][0][k] + local_updates[10][0][k] + local_updates[11][0][k] + local_updates[12][0][k] + local_updates[13][0][k] + local_updates[14][0][k] + local_updates[15][0][k] + local_updates[16][0][k] + local_updates[17][0][k] ) / num_selected_users
                for k in global_model.keys()
            }
            ...
            lp0 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_round[{8}].pkl')
            lp1 = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_round[{8}].pkl')
            local_updates.append(lp0)
            local_updates.append(lp1)
            ...
            lp0_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[0]_local_loss_round[{8}].pkl')
            lp1_loss = torch.load(f'/mydata/flcode/models/rabbitmq-queues/pickles/node[1]_local_loss_round[{8}].pkl')
            loss_locals.append(lp0_loss[0])
            loss_locals.append(lp1_loss[0])
            ...
            for i in range(num_selected_users):
                global_model = {
                k: global_model[k] + (local_updates[0][0][k]+local_updates[1][0][k] + local_updates[2][0][k] + local_updates[3][0][k] + local_updates[4][0][k] + local_updates[5][0][k] + local_updates[6][0][k] + local_updates[7][0][k] + local_updates[8][0][k] + local_updates[9][0][k] + local_updates[10][0][k] + local_updates[11][0][k] + local_updates[12][0][k] + local_updates[13][0][k] + local_updates[14][0][k] + local_updates[15][0][k] + local_updates[16][0][k] + local_updates[17][0][k] + local_updates[18][0][k] + local_updates[19][0][k] ) / num_selected_users
                for k in global_model.keys()
            }
