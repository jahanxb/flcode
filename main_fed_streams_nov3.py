...
def serve(args):
    ...
    try:
        mdb.create_collection('master_global_for_node0')
    except Exception as e:
        print(e)
        pass
    try:
        mdb.create_collection('master_global_for_node1')
    except Exception as e:
        print(e)
        pass
    ...
    for t in range(args.round):
        ...
        if t==0:
            ...
            mdb.master_global_for_node0.insert_one(mdb_msg)
            ...
            mdb_msg = {'task_id':task_queue,'state-ready':True,'consumed':False}
            mdb.master_global_for_node1.insert_one(mdb_msg)    
