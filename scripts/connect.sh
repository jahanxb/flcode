...
do
  ...
  ssh jahanxb@10.10.1.$x -f "sudo rm -rf /mydata/flcode/models/nodes_sftp/global_models/*"
  ssh jahanxb@10.10.1.$x -f "sudo rm -rf /mydata/flcode/models/nodes_sftp/nodes_local/*"
  ssh jahanxb@10.10.1.$x -f "sudo rm -rf /mydata/flcode/models/nodes_sftp/nodes_local_loss/*"
