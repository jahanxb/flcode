...
def serve(args):
    ...
    try:
        ...
        sample_per_users = 12500  # for two users , we take 25000 samples as per the loop
        ...
        for t in range(args.round):
            ...
            # torch.save(net_glob.state_dict(),"/home/jahanxb/PycharmProjects/FLcode/models/temp.pkl")
        ...
        out_file_name = "/home/jahanxb/PycharmProjects/FLcode/models/recv.pkl"
        if os.path.exists(out_file_name):
...
if __name__ == '__main__':
    ...
    server_args = {
        0: {
            "user_index": user_counter, "dataset": "cifar", "gpu": -1, "round": 50
        },
        1: {
