...
# from utils.data_utils_noniid import data_setup, DatasetSplit, fmnist_noniid
...
#     # Define the label flip mapping
#     flip_mapping = {0: 1, 1: 0}  # Example: flip T-shirt/top (0) to Trouser (1)
#     flip_fraction = 1.0  # Example: 10% of users will have their labels flipped
...
if __name__ == '__main__':
    ...
    1: 9,
    3: 7,
    5: 5,  # No change for the middle value
    7: 3,
    9: 1
    }
