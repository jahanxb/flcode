...
def client_node():
    ...
    with grpc.insecure_channel("localhost:9999") as channel:
        ...
        try:
            ...
            args.round = response_node1.round
            args.dataset = response_node1.dataset
            args.tau = 1
            ...
            torch.save(model_update, "/home/jahanxb/PycharmProjects/FLcode/models/node1.pkl")
            time.sleep(60)
            client = lib.FileClient("localhost:9991")
            in_file_name = "/home/jahanxb/PycharmProjects/FLcode/models/node1.pkl"
